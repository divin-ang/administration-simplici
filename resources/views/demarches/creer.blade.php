...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Créer une démarche dans') }} {{$subcontainer_name}}</div>
         ...
         <div class="col-md-6">
          <input type='text' class="form-control"  name="description"  />
            ...
            <div class="form-group row">
                <label for="draft_mode " class="col-md-4 col-form-label text-md-right">{{ __('Brouillon') }}</label>
