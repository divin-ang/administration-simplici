...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Liste des sous catégories') }}</div>
                ...
                <div class="item">
                 ...
                 @foreach($sousCategory as $sous_categorie)
                    ...
                    <a href="{{ url('demarches/'.$sous_categorie->subcontainer_id.'/'.$sous_categorie->subcontainer_name) }}" class="col-3 afficher">Afficher les démarches</a>
                     <a href="{{ url('sous-categorie/modifier/'.$sous_categorie->subcontainer_id.'/'.$sous_categorie->subcontainer_name) }}" class="col modifier" >Modifier</a>
